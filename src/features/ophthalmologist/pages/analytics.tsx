  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5">
      <div className="flex items-start justify-between mb-4">
        ...
        <div
          className={`flex items-center gap-1 text-sm font-medium ${trend === 'up' ? 'text-emerald-600' : 'text-red-500'}`}
        >
          {trend === 'up' ? (
            <TrendingUp size={14} />
          ) : (
      ...
      <div className="ml-56">
        ...
        <main className="p-6">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            ...
            <div className="col-span-2 bg-white rounded-2xl border border-gray-100 p-6 overflow-hidden">
              ...
              <div className="flex items-center justify-center gap-6 mt-4 pt-3 border-t border-gray-100">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">Screenings</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  <p className="text-sm text-gray-500 mb-1">False Positives</p>
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <p className="text-2xl font-bold text-gray-800">v2.4</p>
                  <p className="text-xs text-cyan-600 mt-1">Latest available</p>
                </div>
              </div>
            </div>
