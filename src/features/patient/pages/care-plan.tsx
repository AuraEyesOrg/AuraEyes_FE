    ...
    <PatientLayout>
      ...
      <div className="relative mb-8 overflow-hidden rounded-3xl bg-slate-900 px-8 py-10 shadow-xl">
        ...
        <div className="relative">
          ...
          <h1 className="text-3xl md:text-4xl font-black tracking-tight text-white">
            My Healthcare Roadmap
          </h1>
          <p className="mt-2 text-sm text-slate-300 max-w-xl">
            Your doctor's structured timeline of upcoming care steps. Items are
            sorted by date so you can plan ahead.
          </p>
        </div>
      </div>
      ...
      {roadmapQuery.isLoading ? (
        <div className="flex items-center gap-3 py-12 text-(--text-secondary)">
          <Spinner /> Loading your care plan...
        </div>
      ) : roadmapQuery.error ? (
