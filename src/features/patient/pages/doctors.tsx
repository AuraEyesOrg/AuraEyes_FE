...
//             })
//           }
//           className="group flex h-10 w-10 items-center justify-center rounded-full border border-(--border-color) bg-(--bg-secondary) text-(--text-secondary) transition-all hover:border-brand/40 hover:bg-brand/5 hover:text-brand"
//         >
...
//         {walletBalance !== null && (
//           <button
//             onClick={() => navigate(resolvePathWithLocale('/patient/wallet'))}
//             className={`group flex items-center gap-2 px-4 py-2 rounded-xl border font-bold text-sm transition-all shadow-sm ${
...
//                   : 'bg-slate-50 border-slate-200 text-slate-700 hover:border-brand/30'
//             }`}
//           >
//             {walletSufficient === false ? (
