  ...
  return (
    <div className="min-h-screen bg-(--bg-primary) text-(--text-primary)">
      ...
      <main className="relative overflow-hidden px-6 pb-20 pt-24">
        ...
        <section className="relative mx-auto w-full max-w-4xl rounded-3xl border border-(--border-color) bg-white/70 p-8 text-center shadow-2xl backdrop-blur-sm dark:bg-slate-900/70 md:p-12">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-(--text-secondary)">
            Duong dan ban vua truy cap hien khong ton tai trong he thong AURA.
            Vui long kiem tra lai URL hoac quay ve trang chu de tiep tuc.
          </p>
