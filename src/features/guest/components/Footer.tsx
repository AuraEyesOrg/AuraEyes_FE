    ...
    <footer className="bg-white border-t border-[#E2E8F0]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          {/* Platform */}
          <div>
            <h4 className="font-bold text-[#1A202C] mb-4">Platform</h4>
            <ul className="space-y-2 text-sm text-[#718096]">
              ...
              <li>
                <a className="hover:text-[#319795] transition-colors" href="#">
                  Dashboard
                </a>
              </li>
              <li>
          ...
          {/* Company */}
          <div>
            <h4 className="font-bold text-[#1A202C] mb-4">Company</h4>
            <ul className="space-y-2 text-sm text-[#718096]">
              <li>
                <Link
                  className="hover:text-[#319795] transition-colors"
          ...
          {/* Legal */}
          <div>
            <h4 className="font-bold text-[#1A202C] mb-4">Legal</h4>
            <ul className="space-y-2 text-sm text-[#718096]">
              <li>
                <a className="hover:text-[#319795] transition-colors" href="#">
                  Terms of Service
        ...
        <div className="border-t border-[#E2E8F0] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-[#718096]">
            © 2026 AURA Health. All rights reserved.
          </p>
          <div className="flex gap-4">
            {/* Twitter */}
            <a
              className="text-[#718096] hover:text-[#319795] transition-colors"
              href="#"
            >
