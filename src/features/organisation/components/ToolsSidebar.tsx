    ...
    <aside className="w-16 flex-none flex flex-col items-center py-6 gap-6 bg-white dark:bg-[#0a1f44] border-r border-gray-200 dark:border-[#2d4a6f] z-10">
      ...
      <div className="flex flex-col gap-2 w-full px-2">
        <button
          ...
          title={t('Organisation.toolsSidebar.zoomIn', 'Zoom In')}
        >
        ...
        <button
          ...
          title={t('Organisation.toolsSidebar.zoomOut', 'Zoom Out')}
        >
          <ZoomOut className="w-5 h-5" />
        </button>
        <button
          className="group relative flex items-center justify-center size-10 rounded-lg hover:bg-gray-100 dark:hover:bg-[#1e3a5f] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all mx-auto"
          title={t('Organisation.toolsSidebar.panTool', 'Pan Tool')}
        >
        ...
        <button
          onClick={onReset}
          className="group relative flex items-center justify-center size-10 rounded-lg hover:bg-gray-100 dark:hover:bg-[#1e3a5f] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all mx-auto"
          title={t('Organisation.toolsSidebar.resetView', 'Reset View')}
        >
      ...
      <div className="flex flex-col gap-2 w-full px-2">
        <button
          className="group relative flex items-center justify-center size-10 rounded-lg hover:bg-gray-100 dark:hover:bg-[#1e3a5f] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all mx-auto"
          title={t('Organisation.toolsSidebar.measurement', 'Measurement')}
        >
        ...
        <button
          className="group relative flex items-center justify-center size-10 rounded-lg hover:bg-gray-100 dark:hover:bg-[#1e3a5f] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all mx-auto"
          title={t(
            'Organisation.toolsSidebar.brightnessContrast',
            'Brightness/Contrast'
          )}
        >
        ...
        <button
          ...
          title={t(
            'Organisation.toolsSidebar.comparePrevious',
            'Compare Previous'
          )}
        >
      ...
      <div className="mt-auto mb-4">
        <button
          ...
          title={t(
            'Organisation.toolsSidebar.keyboardShortcuts',
            'Keyboard Shortcuts'
          )}
        >
