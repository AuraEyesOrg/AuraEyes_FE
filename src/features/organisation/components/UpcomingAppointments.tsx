    ...
    <div className="bg-[#1e3a5f] dark:bg-[#1e3a5f] light:bg-white rounded-xl p-6 border border-[#2d4a6f] dark:border-[#2d4a6f] light:border-gray-200">
      ...
      <div className="space-y-3">
        {appointments.map((appointment) => (
          <div
            key={appointment.id}
            className="flex items-center gap-4 p-4 rounded-lg bg-[#0a1f44] dark:bg-[#0a1f44] light:bg-gray-50 border border-[#2d4a6f] dark:border-[#2d4a6f] light:border-gray-200 hover:border-primary transition-colors cursor-pointer"
          >
            ...
            <div className="flex-1 min-w-0">
              <h4 className="text-sm font-semibold text-white dark:text-white light:text-gray-900 mb-1">
                {appointment.patientName}
              </h4>
              <div className="flex items-center gap-3 text-xs text-gray-400 dark:text-gray-400 light:text-gray-600">
