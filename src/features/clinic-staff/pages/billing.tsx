            ...
            <div className="mt-4 grid grid-cols-1 gap-2 md:grid-cols-2">
              {Array.from({ length: 4 }).map((_, index) => (
                <div
                  ...
                  className="skeleton-shimmer h-16 rounded-xl bg-slate-200 dark:bg-slate-700"
                />
              ))}
            </div>
          )}
          ...
          <section className="rounded-3xl border border-(--border-color) bg-(--bg-primary) p-5 md:p-6">
            ...
            {paymentContextQuery.isLoading && (
              <div className="mt-4 space-y-2">
                ...
                <div className="skeleton-shimmer h-20 w-full rounded-xl bg-slate-200 dark:bg-slate-700" />
              </div>
            )}
