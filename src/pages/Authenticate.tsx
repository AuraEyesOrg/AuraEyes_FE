...
import { Eye, EyeOff, Mail, Lock, User, Phone, Shield, Zap, Activity, Stethoscope } from 'lucide-react';
            ...
            <div className="lg:w-[40%] bg-gradient-to-br from-[#1A202C] to-[#2D3748] w-full flex flex-col justify-between p-8 lg:p-12 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col gap-6 my-auto py-12">
                    ...
                    <p className="text-gray-300 text-lg lg:text-xl font-light leading-relaxed max-w-md">
                        Secure access to the next generation of retinal screening tools. Automated diagnostics with 99.8% clinical accuracy.
                    </p>
                ...
                <div className="w-full max-w-[480px] flex flex-col gap-8">
                        ...
                        <div className="flex border-b border-gray-200 gap-8 relative">
                            ...
                            <div 
                                className={`absolute bottom-0 h-[3px] bg-[#1A202C] transition-all duration-300 ease-out ${
                                    authMode === 'login' ? 'left-0 w-[80px]' : 'left-[120px] w-[140px]'
                                }`}
                            />
                            <button
                            ...
                            >
                                <span className="text-sm font-bold tracking-wide uppercase">Create Account</span>
                            </button>
                        </div>
                    </div>
                    ...
                    {authMode === 'login' && (
                        <div>
                            ...
                            <div className="space-y-2">
                                <h2 className="text-3xl font-bold text-[#1A202C] tracking-tight">Access Portal</h2>
                                <p className="text-gray-500 text-base">Welcome Back, Doctor. Please enter your credentials.</p>
                            </div>
                            ...
                            <div className="pt-6 border-t border-gray-100">
                                <div className="flex items-start gap-3 p-4 bg-blue-50/50 rounded-lg border border-blue-100">
                                    ...
                                    <p className="text-xs text-gray-600 leading-relaxed">
                                        Access to this portal is restricted to authorized medical personnel only. Unauthorized access is a
                                        violation of federal law and HIPAA regulations.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    {authMode === 'register' && (
                        <div className="animate-slide-in-right">
                            {/* Page Heading */}
                            <div className="space-y-2">
                                <h2 className="text-3xl font-bold text-[#1A202C] tracking-tight">Create Account</h2>
                                <p className="text-gray-500 text-base">Join AURA to access advanced retinal diagnostics.</p>
                            </div>

                            {/* Form */}
                            <form className="space-y-5" onSubmit={handleSignupSubmit(onRegisterSubmit)}>
                                {/* Full Name */}
                                <div className="space-y-1.5">
                                    <label className="block text-sm font-semibold text-gray-700" htmlFor="register-name">
                                        Full Name
                                    </label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                    ...
                                    {signupErrors.fullName && (
                                        <p className="text-xs text-red-500 mt-1">{signupErrors.fullName.message}</p>
                                    )}
                                </div>
                                ...
                                {/* Phone */}
                                <div className="space-y-1.5">
                                    <label className="block text-sm font-semibold text-gray-700" htmlFor="register-phone">
                                        Phone Number
                                    </label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                    ...
                                    {signupErrors.phone && (
                                        <p className="text-xs text-red-500 mt-1">{signupErrors.phone.message}</p>
                                    )}
                                </div>
                                ...
                                {/* Confirm Password */}
                                <div className="space-y-1.5">
                                    <label className="block text-sm font-semibold text-gray-700" htmlFor="register-confirm-password">
                                        Confirm Password
                                    </label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                    ...
                                    {signupErrors.confirmPassword && (
                                        <p className="text-xs text-red-500 mt-1">{signupErrors.confirmPassword.message}</p>
                                    )}
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <label htmlFor="agree-terms" className="text-xs text-gray-600">
                                        I agree to the{' '}
                                        <Link to="/terms" className="text-[#1F85F5] hover:text-[#00d1c0] font-medium">
                                            Terms of Service
                                        </Link>{' '}
                                        and{' '}
                                        <Link to="/privacy" className="text-[#1F85F5] hover:text-[#00d1c0] font-medium">
                                            Privacy Policy
                                        </Link>
                                    </label>
                                </div>
                                {signupErrors.agreeTerms && (
                                    <p className="text-xs text-red-500 mt-1">{signupErrors.agreeTerms.message}</p>
                                )}
                            ...
                            <div className="pt-6 border-t border-gray-100">
                                <div className="flex items-start gap-3 p-4 bg-blue-50/50 rounded-lg border border-blue-100">
                                    <Shield className="text-[#1F85F5] w-5 h-5 mt-0.5 shrink-0" />
                                    <p className="text-xs text-gray-600 leading-relaxed">
                                        By creating an account, you acknowledge that your data will be processed in accordance with HIPAA
                                        regulations and our security protocols.
                                    </p>
                                </div>
                            </div>
                        </div>
