  ...
  interface TranslationSchema {
            ...
            screening: {
              ...
              launch: {
                ...
                labels: {
                  ...
                  dueToSurgery: string;
                  dueToAnesthesia: string;
                  dueToInfection: string;
                  mainDisease: string;
    ...
    PatientAppointments: {
      ...
      bookingConfirmation: {
        ...
        retinalImagesDesc: string;
        aiResults: string;
        aiResultsDesc: string;
        aiCaseTitle: string;
        caseId: string;
        noOriginalImage: string;
        originalImage: string;
        aiAnnotated: string;
        turnOnAiToPreview: string;
        addRetinalToPreview: string;
        symptoms: string;
        noSymptoms: string;
    ...
    Ophthalmologist: {
      ...
      screeningReview: {
        ...
        share: {
          ...
          sendSelected: string;
          success: string;
          heatmapEdited: string;
          heatmapOriginal: string;
          aiAnnotated: string;
          doctorBoxedOverlay: string;
        };
        shareButton: string;
        status: {
    ...
    PatientWallet: {
      ...
      transactions: {
        ...
        ref: string;
        payNow: string;
        emptyPaymentOrdersDescription: string;
      };
      filters: {
        all: string;
        payment: string;
      ...
      calendar: {
        ...
        walkInModal: {
          ...
          toast: {
            ...
            paymentSyncFailed: string;
            qrBeforeAppointmentDate: string;
    ...
    SystemAdmin: {
      ...
      staffManagement: {
        ...
        modal: {
          ...
          leaveFund: string;
          days: string;
          applyPolicyPlaceholder: string;
          applying: string;
          functionalRoles: string;
          subRolesLabel: string;
          subRoles: {
            Registration: string;
            Screening: string;
            Payment: string;
            ConsultationSupport: string;
          };
        };
      };
      patients: {
      ...
      permissions: {
        ...
        users: {
          selectUserTitle: string;
          selectUserDesc: string;
          staffList: string;
          searchPlaceholder: string;
          loadError: string;
          loadPermError: string;
          updateSuccess: string;
        };
      };
    ...
    ProfessionalNetwork: {
      ...
      collaboration: {
        ...
        consilium: {
          ...
          concludeMessage: string;
          concludeConfirm: string;
          concludeSuccess: string;
          concludeError: string;
          urgentTitle: string;
    ...
    ClinicStaffDashboard: {
      ...
      activityActions: {
        checkedIn: string;
        checkedInAtCounter: string;
        appointmentCreated: string;
        appointmentConfirmed: string;
        appointmentCancelled: string;
        newAppointmentBooked: string;
